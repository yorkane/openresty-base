  ...
  const messages = {
    'zh-CN': {
      ...
      authorization: {
        ...
        bindingTitle: '新增域名绑定', editBindingTitle: '编辑域名绑定', bindingCopy: '填写最后一级前缀，例如 name1；系统会拼接当前实例域名。', domainPlaceholder: 'name1', menuNameHint: '填写后直接作为左侧菜单名称', websocketEnabled: '开启 WebSocket', websocketHint: '仅对需要 WebSocket 的绑定开启', enabledNow: '立即启用', createBinding: '创建绑定', saveBinding: '保存绑定', editBinding: '编辑绑定',
